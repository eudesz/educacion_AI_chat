...
class Document(models.Model):
    """Modelo para documentos subidos con análisis de estructura"""
    ...
    # Campos para análisis de estructura
...
class DocumentStructure(models.Model):
    """Modelo para elementos de estructura de documentos"""
...
class SemanticChunk(models.Model):
    """Modelo para chunks semánticos de documentos"""
